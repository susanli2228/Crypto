...
public class Vtwenty {

	public String text;
	
	public Vtwenty(String s) {
	...
	//Separate String s into 20 buckets
	public static void buckets(String inputText) throws IOException {
		
		char[] letArray = Vtwenty.letter();
		char[] expArray = Vtwenty.expandedArray();
		
		int [] [] letters = new int [20] [26]; 
		...
		int[] maxArray = new int[20];//index of "e" for each row
		
		//find "e" for each bucket/row
		for (int k=0; k<20; k++) {//row by row
			//int maxInd = k;
...
//		maxArray[11] = 11;
		...
		for (int p=0; p<inputText.length(); p++) {
			...
			if (Character.isLetter(oldChar)) {
				...
				int turnBy = turnHowMuch[letIndex%20];
				...
				if (letIndex%20 < 10) {numberText = numberText + letIndex%20;}
				else if (letIndex%20 == 10){numberText = numberText + "a";}
				else if (letIndex%20 == 11){numberText = numberText + "b";}
				else if (letIndex%20 == 12){numberText = numberText + "c";}
				else if (letIndex%20 == 13){numberText = numberText + "d";}
				else if (letIndex%20 == 14){numberText = numberText + "e";}
				else if (letIndex%20 == 15){numberText = numberText + "f";}
				else if (letIndex%20 == 16){numberText = numberText + "g";}
				else if (letIndex%20 == 17){numberText = numberText + "h";}
				else if (letIndex%20 == 18){numberText = numberText + "i";}
				else if (letIndex%20 == 19){numberText = numberText + "j";}
		...
		if (allesGut == true) {
			FileWriter fw = new FileWriter("C:\\Users\\Susan\\OneDrive\\Documents\\CS 4830 - Cryptography\\vigenere_black_20.answer", false);
